...
public class ElecUtils {
    ...
    static String getType(int type) {
        String t = "";
        String ty = String.valueOf(type).substring(0, 3);
...
//        String st = String.valueOf(study).substring(3,5);
    ...
    static int getResourceFromTypeN(int type) {
        int id = 0;
        switch (type) {
            case 0:
                id = R.drawable.excellent;
                break;
            case 1:
                id = R.drawable.free;
                break;
            case 2:
                id = R.drawable.questions;
                break;
            case 3:
                id = R.drawable.ele_tasks;
                break;
            case 4:
                id = R.drawable.sign_tasks;
                break;
            case 5:
            ...
            case 6:
                ...
                break;
            case 7:
                id = R.drawable.notifications;
                break;
        }
        return id;
    }

    static int getResourceFromType(int type) {
        int id = 0;
        switch (type) {
            case 100:
                id = R.mipmap.ic_education;
                break;
            case 101:
                id = R.mipmap.ic_coding;
                break;
            case 102:
                id = R.mipmap.ic_designing;
                break;
            case 103:
                id = R.mipmap.ic_english;
                break;
            case 104:
                id = R.mipmap.ic_arts;
                break;
